...
// SUPABASE_ANON_KEY → "anon public" (la llave pública, NO la "service_role")
//
// Estos dos valores son seguros de dejar visibles en el código del sitio:
// la llave "anon" solo puede hacer lo que las reglas de seguridad (RLS)
